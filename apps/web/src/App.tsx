...
export function App() {
  ...
  const handleGenerate = async () => {
    ...
    setRenderError(null);
    try {
      const fontDef = FONTS.find((f) => f.family === form.fontFamily) ?? FONTS[0];
  ...
  return (
    <div className="min-h-screen p-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">FF14 プロフィールカードジェネレーター</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[400px_1fr] gap-6">
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-slate-800 rounded-lg p-4">
            ...
            <div className="overflow-hidden rounded" style={{ width: 800, height: 420 }}>
              <div style={{ width: 1200, height: 630, transform: "scale(0.6667)", transformOrigin: "top left" }}>
                <Card {...cardProps} />
              </div>
            </div>
          </div>
          ...
          {outputUrl && (
            <div className="bg-slate-800 rounded-lg p-4 flex flex-col gap-3">
              ...
              <img src={outputUrl} alt="generated card" className="w-full rounded" />
              <a
                href={outputUrl}
